...
STATICFILES_DIRS = (
    ...
    '/home/predictiveds/git/palmyr/palmyr/web/static',
)
...
SECRET_KEY = '!ey0^)f)edk*1jkq9-lt&v*!fnwo0rbkh*gd*1q_l!c7lp588$'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/home/predictiveds/git/palmyr/palmyr/web/templates',
)
